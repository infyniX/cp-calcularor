(() => {
    var e = {
                ...
                e.exports = function(e) {
                    ...
                    return t.toString = function() {
                        ...
                        for (var a = 0; a < e.length; a++) {
                            var l = [].concat(e[a]);
                            n && r[l[0]] || (o && (l[2] ? l[2] = "".concat(o, " and ").concat(l[2]) : l[2] = o), t.push(l))
                        }
                    }, t
                }
            },
            3379: (e, t, o) => {
                ...
                function b(e, t) {
                    ...
                    if (t.singleton) {
                        var i = f++;
                        o = v || (v = c(t)), n = p.bind(null, o, i, !1), r = p.bind(null, o, i, !0)
                    } else o = c(t), n = h.bind(null, o, t), r = function() {
                        ! function(e) {
                ...
                e.exports = function(e, t) {
                    ...
                    return function(e) {
                        if (e = e || [], "[object Array]" === Object.prototype.toString.call(e)) {
                            ...
                            for (var i = l(e, t), c = 0; c < o.length; c++) {
                                var d = a(o[c]);
            ...
            9938: function(e) {
                "undefined" != typeof self && self, e.exports = (() => {
                    ...
                    return (() => {
                                    ...
                                    maybeAdjustScroll: function() {
                                        ...
                                        if (t) {
                                            var o = this.getDropdownViewport(),
                                                ...
                                                i = n.bottom,
                                                s = n.height;
                                            if (r < o.top) return this.$refs.dropdownMenu.scrollTop = t.offsetTop;
                                            if (i > o.bottom) return this.$refs.dropdownMenu.scrollTop = t.offsetTop - (o.height - s)
                                        }
                                    },
                        ...
                        function u(e, t, o, n, r, i, s, a) {
                            var l, c = "function" == typeof e ? e.options : e;
                            if (t && (c.render = t, c.staticRenderFns = o, c._compiled = !0), n && (c.functional = !0), i && (c._scopeId = "data-v-" + i), s ? (l = function(e) {
                        ...
                        const p = {
                            ...
                            v = function(e) {
                                var t = {};
                                return Object.keys(e).sort().forEach((function(o) {
                                    t[o] = e[o]
                                })), JSON.stringify(t)
                            };
                        var f = 0;
                        ...
                        const y = u({
                                ...
                                props: {
                                    ...
                                    getOptionKey: {
                                        ...
                                        default: function(e) {
                                            ...
                                            try {
                                                return e.hasOwnProperty("id") ? e.id : v(e)
                                            } catch (t) {
                                    ...
                                    filter: {
                                        ...
                                        default: function(e, t) {
                                            ...
                                            return e.filter((function(e) {
                                                ...
                                                return "number" == typeof n && (n = n.toString()), o.filterBy(e, n, t)
                                            }))
                                        }
                                    },
                                    createOption: {
                                        type: Function,
                                        default: function(e) {
                                            return "object" === i()(this.optionList[0]) ? a()({}, this.label, e) : e
                                        }
                                    },
                                ...
                                watch: {
                                    options: function(e, t) {
                                        var o = this;
                                        !this.taggable && ("function" == typeof o.resetOnOptionsChange ? o.resetOnOptionsChange(e, t, o.selectedValue) : o.resetOnOptionsChange) && this.clearSelection(), this.value && this.isTrackingValues && this.setInternalValueFromOptions(this.value)
                                    },
                                    value: {
                                        immediate: !0,
                                        handler: function(e) {
                                ...
                                methods: {
                                    ...
                                    deselect: function(e) {
                                        var t = this;
                                        this.$emit("option:deselecting", e), this.updateValue(this.selectedValue.filter((function(o) {
                                    ...
                                    toggleDropdown: function(e) {
                                        var o = e.target !== this.searchEl;
                                        o && e.preventDefault();
                                        var n = [].concat(t()(this.$refs.deselectButtons || []), t()([this.$refs.clearButton] || 0));
                                        void 0 === this.searchEl || n.filter(Boolean).some((function(t) {
                                            return t.contains(e.target) || t === e.target
                                        })) ? e.preventDefault() : this.open && o ? this.searchEl.blur() : this.disabled || (this.open = !0, this.searchEl.focus())
                                    },
                                    ...
                                    findOptionFromReducedValue: function(e) {
                                        var o = this,
                                            n = [].concat(t()(this.options), t()(this.pushedTags)).filter((function(t) {
                                                return JSON.stringify(o.reduce(t)) === JSON.stringify(e)
                                            }));
                                        return 1 === n.length ? n[0] : n.find((function(e) {
                                            return o.optionComparator(e, o.$data._value)
                                        })) || e
                                    },
                                    ...
                                    normalizeOptionForSlot: function(e) {
                                        return "object" === i()(e) ? e : a()({}, this.label, e)
                                    },
                                    pushTag: function(e) {
                                ...
                                return o("div", {
                                ...
                                }, [e._t("header", null, null, e.scope.header), e._v(" "), o("div", {
                                    ref: "toggle",
                                    ...
                                    return e._t("selected-option-container", [o("span", {
                                        key: e.getOptionKey(t),
                                        staticClass: "vs__selected"
                                    }, [e._t("selected-option", [e._v("\n            " + e._s(e.getOptionLabel(t)) + "\n          ")], null, e.normalizeOptionForSlot(t)), e._v(" "), e.multiple ? o("button", {
                                        ref: "deselectButtons",
                                        refInFor: !0,
                                ...
                                })), e._v(" "), e._t("search", [o("input", e._g(e._b({
                                    staticClass: "vs__search"
                                }, "input", e.scope.search.attributes, !1), e.scope.search.events))], null, e.scope.search)], 2), e._v(" "), o("div", {
                                    ref: "actions",
                                    ...
                                    tag: "component"
                                })], 1), e._v(" "), e._t("open-indicator", [e.noDrop ? e._e() : o(e.childComponents.OpenIndicator, e._b({
                                    tag: "component"
                                }, "component", e.scope.openIndicator.attributes, !1))], null, e.scope.openIndicator), e._v(" "), e._t("spinner", [o("div", {
                                    directives: [{
                                        name: "show",
                                        rawName: "v-show",
                                ...
                                }, [e._v("Loading...")])], null, e.scope.spinner)], 2)]), e._v(" "), o("transition", {
                                    attrs: {
                                        name: e.transition
                                    }
                                }, [e.dropdownOpen ? o("ul", {
                                    ...
                                    return o("li", {
                                        ...
                                        class: {
                                            "vs__dropdown-option--deselect": e.isOptionDeselectable(t) && n === e.typeAheadPointer,
                                        ...
                                        on: {
                                            ...
                                            click: function(o) {
                                                o.preventDefault(), o.stopPropagation(), e.selectable(t) && e.select(t)
                                            }
                                        }
                                    }, [e._t("option", [e._v("\n          " + e._s(e.getOptionLabel(t)) + "\n        ")], null, e.normalizeOptionForSlot(t))], 2)
                                })), e._v(" "), 0 === e.filteredOptions.length ? o("li", {
                                    staticClass: "vs__no-options"
                                }, [e._t("no-options", [e._v("\n          Sorry, no matching options.\n        ")], null, e.scope.noOptions)], 2) : e._e(), e._v(" "), e._t("list-footer", null, null, e.scope.listFooter)], 2) : o("ul", {
                                    staticStyle: {
                                        display: "none",
                                        visibility: "hidden"
                                    },
    ...
    o.n = e => {
        ...
        var c = [];
        for (var d in pokemon_data)
            for (var u in pokemon_data[d]) {
                var p = 0 == u ? pokemon_names[d] : pokemon_forms[u];
                c.push({
                    code: d + "," + u,
                    label: p[0],
                    icon: p[2]
        ...
        new Vue({
            ...
            computed: {
                pokemon: function() {
                    if (null === this.selected) return null;
                    var e = a(this.selected.split(","), 2),
                        t = e[0],
                        o = e[1];
                    return 0 != +o ? pokemon_forms[o] : pokemon_names[t]
                },
                getCP: function() {
                    if (null === this.pokemon) return "";
                    var e = this.pokemon[5];
                    return NumberFormat(function(e, t, o) {
                        return Math.max(10, Math.floor(.1 * Math.pow((+t[0] + +o[0]) * e, .5) * (+t[1] + +o[1]) * e * Math.pow((+t[2] + +o[2]) * e, .5)))
                    }(h(2 * this.level), e, this.ivs))
                },
                getHP: function() {
                    if (null === this.pokemon) return "";
                    var e = this.pokemon[5];
                ...
                getStats: function() {
                    var e = this.pokemon[5],
                        t = (this.ivs.slice(0), h(2 * this.level));
                    return [(e[0] + +this.ivs[0]) * t, (e[1] + +this.ivs[1]) * t, (e[2] + +this.ivs[2]) * t]
                },
                getImage: function() {
                    return "https://images.gameinfo.io/pokemon/256/p" + this.selected.replace(",", "f").replace(/f0$/, "") + ".png"
                },
                totalStats: function() {
                    return NumberFormat((this.getStats[0] * this.getStats[1] * this.getStats[2] / 1e3).toFixed(0))
                }
            }
        });

        function h(e) {
            var t = [.094, .16639787, .21573247, .25572005, .29024988, .3210876, .34921268, .3752356, .39956728, .4225, .44310755, .4627984, .48168495, .49985844, .51739395, .5343543, .5507927, .5667545, .5822789, .5974, .6121573, .6265671, .64065295, .65443563, .667934, .6811649, .69414365, .7068842, .7193991, .7317, .7377695, .74378943, .74976104, .7556855, .76156384, .76739717, .7731865, .77893275, .784637, .7903, .7953, .8003, .8053, .8103, .8153, .8203, .8253, .8303, .8353, .8403, .8453, .8503, .8553, .8603, .8653];
            return e > 100 && (e = 100), e < 2 && (e = 2), e % 2 ? Math.pow((Math.pow(t[(e - 1) / 2 - 1], 2) + Math.pow(t[(e - 1) / 2], 2)) / 2, .5) : t[e / 2 - 1]
        }
    })()
})();